...
{['consultant','gig_worker','billing'].some((role:any) => hasRole(role))  &&   <button
  ...
  {['sales','admin'].some((role:any) => hasRole(role)) &&     <div className="d-flex justify-content-between mt-5 mb-5">
        <div className="d-flex flex-lg-row flex-md-row flex-column">
          ...
          <div
            className={`filter-btn ${searchValue == "manager_unassigned" ? "act" : ""}`}
            onClick={() => setSearchValue("manager_unassigned")}
          >
            Manager Unassigned
          </div>
          <div
            className={`filter-btn ${searchValue == "assignee_unassigned" ? "act" : ""}`}
      ...
      {['consultant_manager'].some((role:any) => hasRole(role)) &&     <div className="d-flex justify-content-between mt-5 mb-5">
        <div className="d-flex flex-lg-row flex-md-row flex-column">
          <div
            className={`filter-btn ${searchValue == "" ? "act" : ""}`}
            onClick={() => setSearchValue("")}
          ...
          <div
            className={`filter-btn ${searchValue == "assignee_assigned" ? "act" : ""}`}
...
<CustomModal
          ...
          >
            <AssignUser task_id={selectTaskId?selectTaskId:0} recallData={getAllTasks} closeModal={toggleUpdateModal}/>
          </CustomModal>
